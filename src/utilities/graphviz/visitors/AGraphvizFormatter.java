 ...
 * Time : 15:02
 */
public abstract class AGraphvizFormatter extends AFormatter {
    ...
    public String visit(StringGraphvizParameter stringGraphvizParameter) {
        return stringGraphvizParameter.getName() + "=\"" + stringGraphvizParameter.getValue() + "\"";
    }

    public String visit(HtmlGraphvizParameter htmlGraphvizParameter) {
        return htmlGraphvizParameter.getName() + "=" + htmlGraphvizParameter.getHtmlValue();
    }
