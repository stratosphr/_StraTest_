 ...
 * Time : 13:43
 */
public final class ConcreteSimplePathsComputer<V extends ConcreteState, T extends ConcreteTransition> extends AComputer<List<LinkedHashSet<T>>> {
    ...
    public ConcreteSimplePathsComputer(Tuple<Set<V>, List<T>> graph, V startVertex) {
        this(graph, startVertex, null);
    }

    public ConcreteSimplePathsComputer(Tuple<Set<V>, List<T>> graph, V startVertex, V endVertex) {
        this.graph = graph;
