 ...
 * Time : 13:36
 */
public final class NewEUAComputer2 extends AComputer<ApproximatedTransitionSystem> {
    ...
    public NewEUAComputer2(Machine machine, LinkedHashSet<AbstractState> A) {
        ...
        while (!RQ.isEmpty()) {
            ...
            do {
                ...
                for (Event e : _E.get(q)) {
                    LinkedHashSet<AbstractState> targets = E_.get(e).stream().filter(q_ -> !Delta.contains(new AbstractTransition(q, e, q_))).collect(Collectors.toCollection(LinkedHashSet::new));
